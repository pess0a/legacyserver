...
monster.loot = {
	{ name = "small stone", chance = 25000, maxCount = 5 },
	{ name = "gold coin", chance = 90000, maxCount = 25 },
	{ id = 3115, chance = 13000 }, -- bone
	{ name = "mouldy cheese", chance = 5000 },
	{ name = "short sword", chance = 4820 },
	{ id = 3578, chance = 12400 }, -- fish
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -15 },
	{ name = "drunk", interval = 2000, chance = 25, shootEffect = CONST_ANI_POISON, target = false, duration = 10000 },
	{ name = "combat", interval = 2000, chance = 50, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -50, range = 6, shootEffect = CONST_ANI_THROWINGKNIFE, target = false },
}
