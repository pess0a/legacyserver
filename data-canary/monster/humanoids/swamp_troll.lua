...
monster.loot = {
	...
	{ name = "gold coin", chance = 85300, maxCount = 18 },
	{ name = "fishing rod", chance = 3500 },
	{ name = "leather boots", chance = 2500 },
	{ id = 3578, chance = 60000 }, -- fish
	{ id = 3741, chance = 1000 }, -- Medicine Flower
	{ id = 5901, chance = 2140 }, -- wood
	{ name = "swamp grass", chance = 3500 },
	{ name = "medicine pouch", chance = 2500 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -13, condition = { type = CONDITION_POISON, totalDamage = 2, interval = 4000 } },
}
