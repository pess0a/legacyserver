...
monster.loot = {
	{ id = 3031, chance = 99000, maxCount = 145 }, -- gold coin
	{ id = 3061, chance = 120 }, -- life crystal
	{ id = 3322, chance = 100 }, -- dragon hammer
	{ id = 7402, chance = 100 }, -- dragon SLAYER
	{ id = 3302, chance = 100 }, -- dragon lance
	{ id = 3351, chance = 100 }, -- steel helmet
	{ id = 3416, chance = 100 }, -- dragon shield
	{ id = 3449, chance = 80060, maxCount = 10 }, -- burst arrow
	{ id = 3557, chance = 100 }, -- plate legs
	{ id = 3583, chance = 65500, maxCount = 3 }, -- dragon ham
	{ id = 5877, chance = 8000 }, -- green dragon leather
	{ id = 5920, chance = 8000 }, -- green dragon scale
	{ id = 11457, chance = 10000 }, -- dragon's tail
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -30, maxDamage = -70 },
	{ name = "combat", interval = 2000, chance = 50, type = COMBAT_FIREDAMAGE, minDamage = -90, maxDamage = -280, range = 7, radius = 4, shootEffect = CONST_ANI_FIRE, effect = CONST_ME_FIREAREA, target = true },
	{ name = "combat", interval = 2000, chance = 30, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -400, length = 8, spread = 3, effect = CONST_ME_FIREAREA, target = false },
}
