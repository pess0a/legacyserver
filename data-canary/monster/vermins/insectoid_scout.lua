...
monster.loot = {
	...
	{ id = 14089, chance = 200 }, -- Hive Scythe
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -54, condition = { type = CONDITION_POISON, totalDamage = 40, interval = 4000 } },
}
