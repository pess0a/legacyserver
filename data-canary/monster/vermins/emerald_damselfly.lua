...
monster.loot = {
	...
	{ name = "medicine pouch", chance = 3000 },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 35, type = COMBAT_EARTHDAMAGE, minDamage = -8, maxDamage = -12, range = 7, shootEffect = CONST_ANI_POISON, target = false },
}
