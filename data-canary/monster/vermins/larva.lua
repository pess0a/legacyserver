...
monster.loot = {
	{ name = "gold coin", chance = 55000, maxCount = 10 },
	{ name = "meat", chance = 14666 },
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = -7, maxDamage = -25, condition = { type = CONDITION_POISON, totalDamage = 50, interval = 4000 } },
}
